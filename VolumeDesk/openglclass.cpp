...
bool OpenGLClass::IsInitialised()
{
	return m_pInitialised;
}
...
bool OpenGLClass::InitializeOpenGL(HDC hdc, int screenWidth, int screenHeight, float screenDepth, float screenNear, bool vsync)
{
...
void OpenGLClass::OnResizeWindow(int screenWidth, int screenHeight)
{
